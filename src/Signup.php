        ...
        <div class="home-content reg-log bg-black/55 h-100">
            <main class="R-L-content NavList"> <!--flex justify-center items-center text-[4vw]--> 
                    <form  action="logSignVerf.php" method="POST">
                        ...
                        <input class="ring" type="text" id="name" name="name" required>
                        
                        <label for="surname">Last Name: </label>
                        <input class="ring" type="text" id="surname" name="surname" required>

                        <label for="surname">User name: </label>
                        <input class="ring" type="text" id="username" name="username" required>
                        
                        <label for="email">Email: </label>
                        <input class="ring" type="email" id="email" name="email" required>
                        
                        <label for="pswd">Password: </label>
                        <input class="ring" type="text" id="pswd" name="pswd" required>
